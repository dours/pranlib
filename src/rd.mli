...
(** Semilattice. *)
module RDSemilattice (A: ProgramView.Abstractor with type Abstract.node = NodeInfo.t and
...
module RDResults (A: ProgramView.Abstractor with type Abstract.node = NodeInfo.t and
                                                 type Abstract.edge = EdgeInfo.t)
                 (G : CFG.Sig with type Node.t = A.Concrete.node and 
                                   type Edge.t = A.Concrete.edge) :
  sig
